  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on('postgres_changes', {
        ...
        // Only react to changes for this workspace
        const wsId = payload.new?.workspace_id || payload.old?.workspace_id
        if (wsId !== workspace.id) return
        // Refetch all blocked dates
