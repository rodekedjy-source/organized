...
function getBlobs(theme) {
  if (theme === 'light') return {
    bg:'#B5A594',
    blobs:[
      {r:218,g:198,b:172,a:0.72,s:0.62},
      {r:152,g:122,b:95, a:0.60,s:0.48},
      {r:200,g:180,b:155,a:0.58,s:0.55},
      {r:105,g:82, b:62, a:0.45,s:0.36}
    ]
  }
  // Dark theme — rich gold/amber blobs on deep background, clearly animated
  return {
    bg:'#0d0b09',
    blobs:[
      {r:201,g:168,b:76, a:0.38,s:0.65},
      {r:180,g:140,b:60, a:0.30,s:0.50},
      {r:140,g:100,b:40, a:0.22,s:0.45},
      {r:220,g:190,b:100,a:0.18,s:0.35}
    ]
  }
}
...
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}html,body{overflow-x:clip}
