          ...
          :data.map((f)=>{
            ...
            return (
              <div key={f.id} className="formation-row"
                onClick={()=>selectMode&&toggleSelect(f.id)}
                style={{cursor:selectMode?'pointer':'default',background:isSelected?'var(--gold-lt)':'',transition:'background .12s',position:'relative'}}>
