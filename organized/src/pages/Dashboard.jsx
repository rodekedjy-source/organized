    ...
    <div className="card" style={{marginBottom:0}}>
      ...
      <div style={{padding:'1.25rem 1.4rem'}}>
        <div className="goal-track">
          <div className="goal-fill" style={{width:`${pctVal}%`}}/>
        </div>
      ...
      {view==='dashboard'?(
        <div className="app-shell">
          ...
          <main className="main">
            ...
            {page==='overview'    &&<Overview    workspace={workspace} session={session} toast={showToast} setPage={setPage} refetchWorkspace={fetchWorkspace}/>}
