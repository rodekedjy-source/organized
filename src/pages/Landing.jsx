...
.vid-browser-bar { position:absolute; top:52px; left:12px; right:12px; height:32px; background:#f1f1f1; border-radius:10px; display:flex; align-items:center; justify-content:center; z-index:18; }
.vid-browser-bar span { font-size:11px; font-weight:500; color:#555; letter-spacing:0.2px; }
.vid-screen-area { position:absolute; top:94px; left:4px; right:4px; bottom:4px; border-radius:10px; overflow:hidden; }
